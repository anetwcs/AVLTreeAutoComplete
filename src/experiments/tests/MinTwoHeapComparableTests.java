...
public class MinTwoHeapComparableTests {
    ...
    @Before
    public void init() {
        STUDENT_STR = new MinTwoHeapComparable<>();
        STUDENT_DOUBLE = new MinTwoHeapComparable<>();
        STUDENT_INT = new MinTwoHeapComparable<>();
        RAND = new Random(42);
    }
    ...
    public void testHeapWith5Items() {
        PriorityWorkList<String> heap = new MinTwoHeapComparable<>();
    ...
    public void testOrderingDoesNotMatter() {
        PriorityWorkList<String> ordered = new MinTwoHeapComparable<>();
        PriorityWorkList<String> reversed = new MinTwoHeapComparable<>();
        PriorityWorkList<String> random = new MinTwoHeapComparable<>();
    ...
    public void testWithCustomComparable() {
        PriorityWorkList<Coordinate> student = new MinTwoHeapComparable<>();
    ...
    public void checkStructure() {
        PriorityWorkList<Integer> heap = new MinTwoHeapComparable<>();
